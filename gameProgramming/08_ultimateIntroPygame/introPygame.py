...
# Snail
snail_frame_1 = pygame.image.load('img/ultPy/snail1.png').convert_alpha()
snail_frame_2 = pygame.image.load('img/ultPy/snail2.png').convert_alpha()
snail_frames = [snail_frame_1, snail_frame_2]
snail_frame_index = 0
snail_surf = snail_frames[snail_frame_index]

# Fly
fly_frame_1 = pygame.image.load('img/ultPy/fly1.png').convert_alpha()
fly_frame_2 = pygame.image.load('img/ultPy/fly2.png').convert_alpha()
...
# Intro screen
player_stand = pygame.image.load('img/ultPy/player_stand.png').convert_alpha()
