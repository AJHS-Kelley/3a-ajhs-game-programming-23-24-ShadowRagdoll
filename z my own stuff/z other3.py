CHOICES = ["look around", "leave for work", "look around your room", "drive to work", "take it", "leave it", "make it your new table", "make it your home", "talk to them", "run"]
youReady = 0
playerChoice = ""
running = True
...
while running:
    ...
    if playerChoice == "look around your room":
        ...
        if playerChoice == "look around":
            ...
            if playerChoice == "take it":
                ...
                if playerChoice == "make it your new table":
                    ...
                    elif playerChoice == "talk to them":
                    ...
                    if playerChoice == "make it your home":
            ...
            if playerChoice == "drive to work" and youReady == 1:
